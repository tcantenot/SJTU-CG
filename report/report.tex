...
\begin{figure}[!htb]\centering
    \frame{\includegraphics[width=0.9\linewidth]{./images/cover.png}}
\end{figure}
...
\begin{figure}[!Htb]\centering
    \frame{\includegraphics[width=0.9\linewidth]{./images/sss.png}}\label{sss}
...
See \textit{dof.glsl} for implementation details.\\
    ...
    \begin{figure}[!htb]\centering
        \begin{minipage}{0.48\textwidth}
            \frame{\includegraphics[width=\linewidth]{./images/no_dof.png}}
            \caption{Without DOF}
        \end{minipage}
        \begin{minipage}{0.48\textwidth}
        \frame{\includegraphics[width=\linewidth]{./images/dof.png}}
        \caption{With DOF}
        \end{minipage}
    \end{figure}

\begin{figure}[!Htb]\centering
    \frame{\includegraphics[width=0.9\linewidth]{./images/other_dof.png}}
...
In order to have visually pleasing and realistic images, I applied a tonemap operator to scale the computed intensities while keeping the image constrast. I used tonemap operator used in the game \textit{Uncharted 2}.
    ...
    \begin{figure}[!htb]\centering
        \begin{minipage}{0.48\textwidth}
            \frame{\includegraphics[width=\linewidth]{./images/no_tonemap.png}}
            \caption{Without tone mapping}
        \end{minipage}
        \begin{minipage}{0.48\textwidth}
        \frame{\includegraphics[width=\linewidth]{./images/tonemap.png}}
...
\end{itemize}
    ...
    \begin{figure}[!htb]\centering
        \begin{minipage}{0.48\textwidth}
            \frame{\includegraphics[width=\linewidth]{./images/day.png}}
            \caption{Day}
        \end{minipage}
        \begin{minipage}{0.48\textwidth}
        \frame{\includegraphics[width=\linewidth]{./images/dusk.png}}
        \caption{Dusk}
        \end{minipage}
    \end{figure}
